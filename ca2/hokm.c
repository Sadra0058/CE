...
void board(int selectednum[4], int selectedsym[4], int winner, int hokm, int point1, int point2);
int flush(void);
...
int main()
{
    ...
    board(selectednum, selectedsym, winner, hokm, point1, point2);
    ...
    for (int l = -2; l <= length + 2; l++)
    {
        ...
        for (int w = -1; w <= width + 3; w++)
        {
            ...
            /*print team 1*/
                ...
                printf("    team 1: %i", point1);

            /*print team 2*/
            else if (l == length + 1 && w == width + 3)
                printf("    team 2: %i", point2);
